...
from tilecraft.models.schemas import TileSchema, LayerSchema, GeometryType, FeatureAttributes, AttributeType
    ...
    def _create_layer_schema(self, feature_type: FeatureType) -> LayerSchema:
        ...
        schema_map = {
            FeatureType.RIVERS: {
                ...
                'attributes': [
                    FeatureAttributes(name='name', type=AttributeType.STRING, description='River name'),
                    FeatureAttributes(name='waterway', type=AttributeType.STRING, description='Waterway type'),
                ]
            },
            FeatureType.FOREST: {
                'geometry': GeometryType.POLYGON,
                'attributes': [
                    FeatureAttributes(name='name', type=AttributeType.STRING, description='Forest name'),
                    FeatureAttributes(name='natural', type=AttributeType.STRING, description='Natural feature type'),
                    FeatureAttributes(name='landuse', type=AttributeType.STRING, description='Land use type'),
                ]
            },
            FeatureType.WATER: {
                'geometry': GeometryType.POLYGON,
                'attributes': [
                    FeatureAttributes(name='name', type=AttributeType.STRING, description='Water body name'),
                    FeatureAttributes(name='natural', type=AttributeType.STRING, description='Natural feature type'),
                ]
            },
            FeatureType.LAKES: {
                'geometry': GeometryType.POLYGON,
                'attributes': [
                    FeatureAttributes(name='name', type=AttributeType.STRING, description='Lake name'),
                    FeatureAttributes(name='water', type=AttributeType.STRING, description='Water type'),
                ]
            },
            FeatureType.PARKS: {
                'geometry': GeometryType.POLYGON,
                'attributes': [
                    FeatureAttributes(name='name', type=AttributeType.STRING, description='Park name'),
                    FeatureAttributes(name='leisure', type=AttributeType.STRING, description='Leisure type'),
                ]
            },
            FeatureType.ROADS: {
                'geometry': GeometryType.LINESTRING,
                'attributes': [
                    FeatureAttributes(name='name', type=AttributeType.STRING, description='Road name'),
                    FeatureAttributes(name='highway', type=AttributeType.STRING, description='Highway type'),
                ]
            },
            FeatureType.BUILDINGS: {
                'geometry': GeometryType.POLYGON,
                'attributes': [
                    FeatureAttributes(name='building', type=AttributeType.STRING, description='Building type'),
                    FeatureAttributes(name='height', type=AttributeType.NUMBER, description='Building height'),
                ]
            }
        }
        
        config = schema_map.get(feature_type, {
