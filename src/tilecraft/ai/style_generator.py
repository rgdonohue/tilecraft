...
class StyleGenerator:
    ...
    def _generate_default_style(self, schema: Dict[str, Any], palette: PaletteConfig) -> Dict[str, Any]:
        """
    ...
    def _create_style_layer(self, layer_name: str, geometry_type: str, colors: Dict[str, str], layer_info: Dict) -> Dict[str, Any]:
        """
        ...
        if geometry_type == "linestring":
            ...
            base_layer.update({
                ...
                "paint": {
                    ...
                    "fill-opacity": 0.6,
                    "fill-outline-color": colors.get(f"{layer_name}_outline", colors["outline"])
                }
            })
